...
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{x =} \StringTok{"Month"}\NormalTok{, }\DataTypeTok{y =} \KeywordTok{expression}\NormalTok{(}\StringTok{"Temp"}\NormalTok{ ( degree}\OperatorTok{*}\NormalTok{C)), }\DataTypeTok{color =} \StringTok{""}\NormalTok{)}\OperatorTok{+}
