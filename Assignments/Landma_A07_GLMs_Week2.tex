...
\NormalTok{NTL.chem.July <-}\StringTok{ }\NormalTok{NTL.chem }\OperatorTok{%>%}
...
\KeywordTok{dim}\NormalTok{(NTL.chem.July)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{TempAIC <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ NTL.chem.July, }
...
\begin{Highlighting}[]
\CommentTok{#6}
\NormalTok{Tempancova.interaction <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ NTL.chem.July, temperature_C }\OperatorTok{~}\StringTok{ }\NormalTok{lakename }\OperatorTok{*}\StringTok{ }\NormalTok{depth)}
\KeywordTok{summary}\NormalTok{(Tempancova.interaction)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Tempplot <-}\StringTok{ }\KeywordTok{ggplot}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ NTL.chem.July, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ depth, }\DataTypeTok{y =}\NormalTok{ temperature_C, }\DataTypeTok{color =}\NormalTok{ lakename)) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{geom_point}\NormalTok{(}\DataTypeTok{alpha =} \FloatTok{0.5}\NormalTok{, }\DataTypeTok{size =} \FloatTok{0.75}\NormalTok{) }\OperatorTok{+}\StringTok{ }
...
\includegraphics{Landma_A07_GLMs_Week2_files/figure-latex/unnamed-chunk-4-1.pdf}
