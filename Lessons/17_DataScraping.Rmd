...
### first step is to specify the url where the data is coming form 
### you can call your url any name 
### can also past url directly into read_html function 
...
## above we are telling R to do three steps... go to the webpage (as we defined by url above), read in the specific nodes we determines using selector gadget tool, read i the html text from those nodes 
...
> Generally as a higher percentage of the estuary area is assessed, a lower % of the estuary is impaired. 
...
> Gray aesthetic represents an NA int he % impaired TMDL column 
